...
class myLoadDS(Dataset):
    ...
    def __getitem__(self, index):
        timgs = get_images(self.fns[index]) #houston we have a problem! issue with multiprocessing and pickling (https://github.com/pytorch/vision/issues/689). Fixed by forcing fork
